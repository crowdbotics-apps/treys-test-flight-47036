"""
Django settings for treys_test_flight_47036 project.
...
ROOT_URLCONF = 'treys_test_flight_47036.urls'
...
WSGI_APPLICATION = 'treys_test_flight_47036.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "treys_test_flight_47036 API",
    "DESCRIPTION": "API documentation for treys_test_flight_47036 App",
    "VERSION": "v1",
}
